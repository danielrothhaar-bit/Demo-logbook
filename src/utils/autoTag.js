...
/**
 * Run all detection passes for a note. Currently this is just category keyword
 * matching — puzzle/component name auto-attach was removed in favour of
 * explicit dropdowns in the Live action modals.
 */
export function analyzeNoteText(text, { categories = [] } = {}) {
  return {
